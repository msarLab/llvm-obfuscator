...
void StringObfuscation::addDecodeFunction(Module *mod, std::vector<encVar *> *gvars) {
    ...
    for (unsigned i = 0, e = gvars->size(); i != e; ++i) {
        ...
        CastInst *int64_idxprom = new ZExtInst(int32_i, IntegerType::get(mod->getContext(), 64), "idxprom",
                                               label_for_body);
        ...
        Instruction *ptr_arrayidx = GetElementPtrInst::Create(NULL, gvar, ref_ptr_32_indices, "arrayidx",
                                                              label_for_body);
        // Load
